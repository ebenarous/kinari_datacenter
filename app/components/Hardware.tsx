...
const Hardware: React.FC = () => {
  ...
  const glassImage = "/glasses-green.jpeg";
  ...
  const features = [
    ...
    {
      icon: <BatteryFull className="w-6 h-6 text-green-400" />,
      title: "Battery",
      details: [
    ...
    {
      icon: <Feather className="w-6 h-6 text-green-400" />,
      title: "Weight",
      details: [
    ...
    <section id="hardware" className="py-24 bg-black border-t border-white/5">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          {/* Left Column: Image */}
          <div className="relative w-full aspect-[16/9] rounded-2xl overflow-hidden bg-zinc-900 border border-white/10 shadow-2xl shadow-green-900/10 group">
            <img 
                src={glassImage} 
